...
if ($dia <> "Fri"){
    $amanha = date('d-m-Y', strtotime("+1 days",strtotime($data)));

       $sql = mysql_query("INSERT INTO `agenda`(`dia`, `mes`, `autor`, `hrentrada`, `hrsaida`, `data`, `setor` ) VALUES ('$dia', '$mes','$autor', 'FALTA', 'FALTA', '$amanha', '$setor')") or die(mysql_error());
